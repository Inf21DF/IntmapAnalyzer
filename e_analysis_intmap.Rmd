...
ggplot(data = TreeLinearity, aes(x = Linearity, y = TreeHeight)) + geom_point() + labs(x="Linearität", y="Größe", color="Typ")  + ggtitle("Linearität im Bezug zur Größe betrachtet")
