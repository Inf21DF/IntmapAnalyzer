...
ggplot(stack(part_invoked_df), aes(x = ind, y = values)) + geom_boxplot() + scale_y_continuous(trans = "log2") + labs(x="Datenstruktur", y="Anzahl", color="Typ") + ggtitle("Verteilung Datenstrukturen (logarithmische Skalierung)")


ggplot(common_stats_cleaned, aes(x =IntInvoked))  +  geom_boxplot() + scale_x_continuous(trans = "log2") + labs(x="Anzahl", y="Single", color="Typ") + ggtitle("Verteilung Single (logarithmische Skalierung)")
```
...
ggplot(stack(part_invoked_df), aes(x = ind, y = values)) +  geom_boxplot() + labs(x="Datenstruktur", y="Anzahl", color="Typ") + ggtitle("Verteilung Datenstrukturen - IMArray und IMTree")
```
...
colnames(part_deleted_df)[colnames(part_deleted_df) == 'common_stats_cleaned.IntDeleted'] <- 'Single'
...
ggplot(stack(part_deleted_df), aes(x = ind, y = values)) +  geom_boxplot() + scale_y_continuous(trans = "log2") + labs(x="Datenstruktur", y="Anzahl Löschungen", color="Typ") + ggtitle("Verteilung Datenstrukturen (gelöscht) (logarithmische Skalierung)")


ggplot(common_stats_cleaned, aes(x = EmptyDeleted))  +  geom_boxplot() + scale_x_continuous(trans = "log2") + labs(x="Anzahl Löschungen", y="Empty", color="Typ") + ggtitle("Verteilung Empty (gelöscht) (logarithmische Skalierung)")
```
