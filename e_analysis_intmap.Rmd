...
```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountGetVal)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 40000000)) + ggtitle("Array - CountGetVal (Logarithmische Skalierung)")

problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountGetVal)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 40000000)) + ggtitle("Array - CountGetVal, ab 3. Quartil (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountGetRef)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 40000000)) + ggtitle("Array - CountGetRef (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountGetRef)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 4000000)) + ggtitle("Array - CountGetRef, ab 3. Quartil (Logarithmische Skalierung)")
```



```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountAssign)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 3000)) + ggtitle("Array - CountAssign (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountAssign)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 3000)) + ggtitle("Array - CountAssign, ab 3. Quartil (Logarithmische Skalierung)")
```


```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountDelKey)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 17500)) + ggtitle("Array - CountDelKey (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountDelKey)) + stat_boxplot(geom = "errorbar") + geom_boxplot()  + scale_x_continuous(trans = "log2", limits = c(-0.01, 17500)) + ggtitle("Array - CountDelKey, ab 3. Quartil (Logarithmische Skalierung)")

```


```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountArrayToTree)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 17500)) + ggtitle("Array - CountArrayToTree (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountArrayToTree)) + stat_boxplot(geom = "errorbar") + geom_boxplot()+ scale_x_continuous(trans = "log2", limits = c(-0.01, 2000)) + ggtitle("Array - CountArrayToTree, ab 3. Quartil (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=CountTreeToArray)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 20000)) + ggtitle("Array - CountTreeToArray (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=CountTreeToArray)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 2000)) + ggtitle("Array - CountTreeToArray, ab 3. Quartil (Logarithmische Skalierung)")
```


```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=NumberOfItems)) + stat_boxplot(geom = "errorbar") + geom_boxplot()  + scale_x_continuous(trans = "log2", limits = c(-0.01, 50000)) + ggtitle("Array - NumberOfItems (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=NumberOfItems)) + stat_boxplot(geom = "errorbar") + geom_boxplot()+ scale_x_continuous(trans = "log2", limits = c(-0.01,  50000)) + ggtitle("Array - NumberOfItems, ab 3. Quartil (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% ggplot(aes(x=MinMaxDistance)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01,  500000)) + ggtitle("Array - MinMaxDistance (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=MinMaxDistance)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01,  500000)) + ggtitle("Array - MinMaxDistance, ab 3. Quartil (Logarithmische Skalierung)")
...
problems_array %>% ggplot(aes(x=Density)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + ggtitle("Array - Density")
```

```{r, echo=FALSE}
problems_array %>% filter(NumberOfItems > 3) %>% ggplot(aes(x=Density)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + ggtitle("Array - Density, ab 3. Quartil")
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=CountGetRef)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 3000000)) + ggtitle("CountGetRef (Logarithmische Skalierung)")
```


```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=CountGetRef)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 3000000)) + ggtitle("CountGetRef, ab 3. Quartil (Logarithmische Skalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=CountAssign)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 320)) + ggtitle("CountAssign (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=CountAssign)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 320)) + ggtitle("CountAssign, ab 3. Quartil (Logarithmische Skalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=CountDelKey)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 10000)) + ggtitle("CountDelKey (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=CountDelKey)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 10000)) + ggtitle("CountDelKey, ab 3. Quartil (Logarithmische Skalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=CountArrayToTree)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 2000)) + ggtitle("CountArrayToTree (Wurzelskalierung)")
```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=CountArrayToTree)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 2000)) + ggtitle("CountArrayToTree, ab 3. Quartil (Wurzelskalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=CountTreeToArray)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 2000)) + ggtitle("CountTreeToArray (Wurzelskalierung)")
```


```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=CountTreeToArray)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 2000)) + ggtitle("CountTreeToArray, ab 3. Quartil (Wurzelskalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=NumberOfItems)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 6000)) + ggtitle("NumberOfItems (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=NumberOfItems)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 6000)) + ggtitle("NumberOfItems, ab 3. Quartil (Logarithmische Skalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=MinMaxDistance)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 400000)) + ggtitle("MinMaxDistance (Logarithmische Skalierung)")
```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=MinMaxDistance)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "log2", limits = c(-0.01, 400000)) + ggtitle("MinMaxDistance, ab 3. Quartil (Logarithmische Skalierung)")
```
...
```{r, echo=FALSE}
problems_tree %>% ggplot(aes(x=Linearity)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 200)) + ggtitle("Linearity (Wurzelskalierung)")

```

```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% ggplot(aes(x=Linearity)) + stat_boxplot(geom = "errorbar") + geom_boxplot() + scale_x_continuous(trans = "sqrt", limits = c(-0.01, 200)) + ggtitle("Linearity, ab 3. Quartil (Wurzelskalierung)")
...
```{r, echo=FALSE}
problems_tree %>% filter(NumberOfItems > 7) %>% filter(Linearity < 50) %>% ggplot(aes(x=Linearity)) + stat_boxplot(geom = "errorbar") + geom_boxplot()
```
