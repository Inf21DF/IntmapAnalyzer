...
ggplot(common_stats_cleaned, aes(x =IntInvoked))  +  geom_boxplot() + labs(x="Anzahl Aufrufe", y="Integer", color="Typ") + ggtitle("Verteilung IMSingle (aufgerufen)")
```
...
```{r, echo=FALSE}
# IMArray-Korrelation
problems_array %>% ggplot(aes(x = NumberOfItems, y = CountTreeToArray)) + geom_point() + ggtitle("IMArray2 - Korrelation zw. CountTreeToArray und Elementenzahl")
problems_array %>% ggplot(aes(x = NumberOfItems, y = CountArrayToTree)) + geom_point(alpha = 0.2)  + ggtitle("IMArray - Korrelation zw. CountArrayToTree und Elementenzahl")
...
```{r, echo=FALSE}
# IMTree-Korrelation
problems_tree %>% ggplot(aes(x = NumberOfItems, y = CountTreeToArray)) + geom_point(alpha = 0.2)  + ggtitle("IMTree - Korrelation zw. CountTreeToArray und Elementenzahl")
problems_tree %>% ggplot(aes(x = NumberOfItems, y = CountArrayToTree)) + geom_point(alpha = 0.2)  + ggtitle("IMTree - Korrelation zw. CountArrayToTree und Elementenzahl")
problems_tree %>% ggplot(aes(x = NumberOfItems, y = Linearity)) + geom_point(alpha = 0.2)  + ggtitle("IMTree - Korrelation zw. Linearität und Elementenzahl")
problems_tree %>% ggplot(aes(x = NumberOfItems, y = Density)) + geom_point(alpha = 0.2)  + ggtitle("IMTree - Korrelation zw. Dichte und Elementenzahl")
